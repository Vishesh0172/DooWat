...
@Composable
fun SnowAnimation(modifier: Modifier = Modifier, startAnimation: Boolean, isDay: Boolean) {
    ...
    Box(modifier = modifier.fillMaxSize()) {
        ...
        Image(
            ...
            painter = painterResource(if(!isDay) R.drawable.snow_night_background else R.drawable.snow_day_background),
